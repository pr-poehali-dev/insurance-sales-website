...
const faqs = [
  { q: "Сколько стоит страховка?", a: "У нас 4 тарифа: Травмы — 6 000 ₽/год (выплата до 50 000 ₽), Травмы + острые болезни — 7 000 ₽/год (до 100 000 ₽), Травмы + заболевания — 20 000 ₽/год (до 150 000 ₽), Всё включено со стационаром — 35 000 ₽/год (до 300 000 ₽)." },
              ...
              <form onSubmit={handleSubmit} className="bg-white/10 backdrop-blur-sm rounded-3xl p-8 border border-white/20 space-y-6">
                ...
                <label className="flex items-start gap-3 cursor-pointer group">
                  ...
                  <span className="text-white/60 text-xs leading-relaxed group-hover:text-white/80 transition-colors">
                    Я даю согласие на обработку персональных данных в соответствии с Федеральным законом №152-ФЗ «О персональных данных» и соглашаюсь с условиями страхования от Ингосстрах
                  </span>
                </label>
